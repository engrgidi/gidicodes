...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO project (name, link, image) VALUES ('$name', '$link', '$folder')";
    $result = $conn->query($sql);
   
    if ($result === TRUE) {
        if (move_uploaded_file($tempname, $folder)) {
            $msg = "<div class='alert alert-success'>{$name} uploaded successfully</div>";
        } else {
                                        ...
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" method="POST">
                                            <div class="card-body card-block">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Enter Name"  class="form-control bg-transparent-secondary" name="name" value="" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="link">Link</label>
                                                    <input type="text" placeholder="Enter Link"  class="form-control bg-transparent-secondary" name="link" value="" required>
                                                </div>
                                                <div class="form-group">
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td> <a href="?type=delete&id=<?php echo $row['id']; ?>" class="btn btn-alert"><i class="fas fa-trash"></i></a>
                                        <a href="edit_project.php?id=<?php echo $row['id']; ?>" class="btn btn-alert"><i class="fas fa-edit"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                <?php $i++;
