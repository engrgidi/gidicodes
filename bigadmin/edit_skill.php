...
if (isset($_POST['update'])) {
    ...
    $email = $_POST['email'];
    $sql = "UPDATE level SET prog_bar ='$prog_bar', prog_language='$prog_language' WHERE id='$id'";
                            ...
                            <div class="row">
                                ...
                                ?>
                                        <div class="col-xl-6 col-lg-6 mb-20">
                                            <input name="prog_language" type="text" required value="<?php print $row['prog_language']; ?>">

                                        </div>
                                        <div class="col-xl-6 col-lg-6 mb-20">
                                            <input name="prog_bar" type="text" required value="<?php print $row['prog_bar']; ?>">
