...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO logo (descr, image) VALUES ('$descr', '$filename')";
...
if ($type == 'delete') {
    ...
    $delete_sql = "DELETE from bio  where id='$id'";
                    ...
                    <div class="col-md-8 offset-md-2">
                        <form id="contact-form" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="contact-form" method="POST">
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 mb-20">
                                    <textarea name="descr" id="text-message" cols="50" rows="50" placeholder="Motto*" required></textarea>
                                </div>
