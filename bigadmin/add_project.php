...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO project (name, link, image) VALUES ('$name', '$link', '$filename')";
                    ...
                    <div class="col-md-8 offset-md-2">
                        <form id="contact-form" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="contact-form" method="POST">
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 mb-20">
                                    <input name="name" type="text" required placeholder="Enter Name Of project">
                                </div>

                                <div class="col-xl-12 col-lg-12 mb-20">
                                    <input name="link" type="text" required placeholder="Enter Url Link">
                                </div>
